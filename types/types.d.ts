...
export type SortableTreeRenderLabelFunction = (data: SortableTreeKeyValue) => string;
export type SortableTreeOnChangeFunction = ({ nodes, movedNode, srcParentNode, targetParentNode, }: SortableTreeDropResultData) => void;
export type SortableTreeOnClickFunction = (event: Event, node: SortableTreeNodeComponent) => void;
export type SortableTreeConfirmFunction = (movedNode: SortableTreeNodeComponent, targetParentNode: SortableTreeNodeComponent) => Promise<boolean>;
